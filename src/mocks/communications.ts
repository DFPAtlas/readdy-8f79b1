...
export const demoNotifications: NotificationRecord[] = [
  ...
  },
  {
    ...
    category: 'system',
    title: 'SiteLedger update — Phase 8 deployed',
...
export const demoConversations: ConversationRecord[] = [
  ...
  },
  {
    ...
    participants: [
      ...
      { participantType: 'system', name: 'SiteLedger', avatarInitials: 'SL', addedAt: '2026-08-03T10:00:00Z', muted: true },
    ],
    messages: [
      {
        id: 'msg-5a',
...
export const demoDeliveryRecords: DeliveryRecord[] = [
  ...
  { id: 'del-5', eventType: 'qualification_expiring', recipient: 'james.lawrence@siteledger.co.uk', channel: 'email', status: 'failed', attempts: 2, lastError: 'Temporary SMTP error — connection timeout', scheduledAt: '2026-08-05T06:30:00Z', createdAt: '2026-08-05T06:30:00Z' },
  { id: 'del-6', eventType: 'daily_digest', recipient: 'martin@siteledger.co.uk', channel: 'email', status: 'pending', attempts: 0, scheduledAt: '2026-08-05T21:00:00Z', createdAt: '2026-08-05T09:00:00Z' },
